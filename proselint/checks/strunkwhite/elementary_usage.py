...
2. In a series of three or more terms with a conjunction, use a comma after each term except the last.
...
7. Use a colon after an independent clause if you introduce: a list of particulars, an appositive, an application, or an illustative quotation.
8. Use a dash to set off an aburpt break or interruption and to announce a long appositive or summary.
