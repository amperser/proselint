...
@limit_results(3)
def check_ellipsis(_text: str) -> list[CheckResult]:
...
@limit_results(1)
def check_copyright_symbol(_text: str) -> list[CheckResult]:
...
@limit_results(3)
def check_trademark_symbol(_text: str) -> list[CheckResult]:
...
@limit_results(3)
def check_registered_trademark_symbol(_text: str) -> list[CheckResult]:
...
@limit_results(3)
def check_sentence_spacing(_text: str) -> list[CheckResult]:
...
@limit_results(3)
def check_multiplication_symbol(_text: str) -> list[CheckResult]:
...
@limit_results(3)
def check_curly_quotes(_text: str) -> list[CheckResult]:
...
def disabled_check_en_dash_separated_names(text: str) -> list[CheckResult]:
...
def check_apostrophes(text: str) -> list[CheckResult]:
    ...
    results.extend(
        consistency_check(text, [[r"\w+'s", r"\w+´s"]], err, msg, ignore_case=False)
    )
    return results
