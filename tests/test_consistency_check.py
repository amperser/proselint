...
from proselint.lint_checks import consistency_check as chk
...
class TestCheck(Check):
    ...
    def test_smoke(self):
        ...
        assert chk("Painting colour on color", self.L, self.err, self.msg) != []
        assert chk("Painting colour on colour", self.L, self.err, self.msg) == []
